class PC {
    ...
    constructor(svg, data, dimensions, width = 600, height = 400) {
        this.svg = svg;
        this.data = data;
    ...
    initialize() {
        ...
        this.groupLines = this.container.append("g");
    ...
    update(brushedData, colorVar, groupNum) {

        this.groupData = (groupNum !== "all") ? this.data.filter(d => d[colorVar] === groupNum) : this.data ;
        ...
        if(brushedData === this.data) {
            if(groupNum === 'all'){    
                ...
                this.focusedLines
                    ...
                    brushedData.filter(d => d[colorVar] === groupNum);       
                ...
                if(groupNum === 'all'){
                    ...
                    brushedData = brushedData.filter(d => d[colorVar] === groupNum); 
